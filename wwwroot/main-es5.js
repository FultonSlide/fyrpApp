...
var routingComponents = [_user_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"]];
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.loginRedirect = function () {
        this.router.navigate(['/login']);
    };
    AppComponent.prototype.login = function ($e) {
        var _this = this;
        this.username = $e.username;
        this.password = $e.password;
        console.log(this.username, this.password);
        this._httpService.post('/api/values', $e).subscribe(function (values) {
            console.log(values.json());
            _this.loginReturnStatus = values.json();
        });
